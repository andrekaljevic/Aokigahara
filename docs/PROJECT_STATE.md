...
`construction_code_v2/gen_asset_packs.py` from thirteen reference photographs supplied by the
...
| `ivy_rootlet_macro` | ivy-rootlet bark macro, the sharpest bark source; diffuse-shade preset | full; no sky visible |
